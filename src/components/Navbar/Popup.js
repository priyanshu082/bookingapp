...
export const Popup = ({toggle}) => {
  ...
  return (
    <div className={`${toggle ? "flex" : "hidden"} z-[6000] p-6  absolute h-[200px] right-0 mx-4  min-w-[140px] w-[230px] border-[1px] border-gray-300 rounded-xl mt-[55px] mr-[50px] bg-white shadow-[10px_20px_30px_-10px_rgba(0,0,50,0.2)]`}>
    <ul>
            <div>
